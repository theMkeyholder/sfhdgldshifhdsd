...
dellist=(ele)=>{del(ele.parentElement)}
...
[...document.getElementsByClassName('blue')].forEach((x)=>{new Sortable(x,{group:"blob",onAdd:(e)=>{
	if(e.item.parentElement.childElementCount>1) { if(e.from.classList.value!='forjs' || e.to.classList.value!='forjs'){ e.from.appendChild(e.item)}else{fdel(e.item)}}
}})})
},50)}